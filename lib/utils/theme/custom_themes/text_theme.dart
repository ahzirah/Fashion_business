...
class ZTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withValues()),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white.withValues()),
  );
}